...
const REASONS = {
  ...
  'no-migration': 'На сервере не применены миграции базы',
  'not-configured': 'Сервер настроен не до конца',
  'server-error': 'Сервер ответил ошибкой — загляните в wrangler tail',
