...
const REASONS = {
  ...
  'no-migration': 'На сервере не применены миграции базы. Напишите администратору.',
  'not-configured': 'Сервер настроен не до конца. Напишите администратору.',
  'server-error': 'Сервер ответил ошибкой. Попробуйте позже.',
